...
const SubmissionsReportUnregistered = ({ event, filters, submissions }) => {
...
SubmissionsReportUnregistered.Layout = ViewEventLayout;

export default SubmissionsReportUnregistered;
