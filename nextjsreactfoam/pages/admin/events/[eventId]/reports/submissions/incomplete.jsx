...
const SubmissionsReportIncomplete = ({ event, filters, submissions }) => {
...
SubmissionsReportIncomplete.Layout = ViewEventLayout;

export default SubmissionsReportIncomplete;
