...
const SubmissionsReportConflicted = ({ event, filters, submissions }) => {
...
SubmissionsReportConflicted.Layout = ViewEventLayout;

export default SubmissionsReportConflicted;
