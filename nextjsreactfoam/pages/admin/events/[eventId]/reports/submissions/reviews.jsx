...
const SubmissionsReportReviews = ({ event, filters, reviews }) => {
  ...
  if (session) {
    try {
      ...
      const submissionFiltersResponse = await api({
        url: `/events/${context.params.eventId}/submissions/filters/reviews`,
        headers,
      });
      ...
      return {
        props: {
          ...
          reviews: submissionsResponse.data.data,
        },
      };
    } catch (e) {
      return {
...
SubmissionsReportReviews.Layout = ViewEventLayout;

export default SubmissionsReportReviews;
