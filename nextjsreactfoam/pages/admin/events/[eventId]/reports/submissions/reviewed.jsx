...
const SubmissionsReportReviewed = ({ event, filters, revieweds }) => {
    ...
    try {
      ...
      return {
        props: {
          ...
          revieweds: submissionsResponse.data.data,
        },
      };
    } catch (e) {
      return {
...
SubmissionsReportReviewed.Layout = ViewEventLayout;

export default SubmissionsReportReviewed;
