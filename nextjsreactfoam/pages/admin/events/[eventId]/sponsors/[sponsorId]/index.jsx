...
import EventSponsorViewTable from "@/components/forPage/EventSponsor/EventSponsorView/EventSponsorViewTable";
import EventSponsorViewField from "@/components/forPage/EventSponsor/EventSponsorView";
...
const Delegates = ({ sponsor, context }) => {
  ...
  return (
    <ContentErrorBoundary>
      ...
      <Panel title="Personal Information" color="inverse">
        {" "}
        <EventSponsorViewTable />
      </Panel>
      <Panel>
        <EventSponsorViewField />
      </Panel>
    </ContentErrorBoundary>
  );
};
