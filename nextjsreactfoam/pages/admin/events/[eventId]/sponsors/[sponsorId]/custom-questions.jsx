...
import EventSponsorCustomQuestion from "@/components/forPage/EventSponsor/EventSponsorCustomQuestion"
...
const Delegates = ({ sponsor, context }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader title="Custom Questions" />
      <Panel title="Custom Questions" color="inverse"> <EventSponsorCustomQuestion/></Panel>
