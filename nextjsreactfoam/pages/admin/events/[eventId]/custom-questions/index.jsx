...
const CustomQuestions = ({
  ...
  const onSaveChanges = async (data) => {
    try {
      ...
      <Link
      href ={{
        pathname: '/admin/events/[eventId]/registration/attendees',
        query: data
      }}
     ></Link>
...
CustomQuestions.authorized = true;
CustomQuestions.allowedRoles = [ADMIN];
CustomQuestions.Layout = ViewEventLayout;
