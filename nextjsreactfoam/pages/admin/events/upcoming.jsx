...
const UpcomingEventsPage = ({ events, context, session, meta }) => {
...
UpcomingEventsPage.authorized = true;
UpcomingEventsPage.allowedRoles = [ADMIN];
UpcomingEventsPage.Layout = DashboardLayout;
UpcomingEventsPage.defaultProps = {
  events: [],
};
