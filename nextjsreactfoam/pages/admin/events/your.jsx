...
const YourEventsPage = ({ events, context, session, meta }) => {
...
YourEventsPage.authorized = true;
YourEventsPage.allowedRoles = [ADMIN];
YourEventsPage.Layout = DashboardLayout;
YourEventsPage.defaultProps = {
  events: [],
};
