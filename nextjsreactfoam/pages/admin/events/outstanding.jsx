...
const OutstandingEventsPage = ({ events, context, session, meta }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader
        ...
        title={t("common.outstandingEntity", {
...
OutstandingEventsPage.authorized = true;
OutstandingEventsPage.allowedRoles = [ADMIN];
OutstandingEventsPage.Layout = DashboardLayout;
OutstandingEventsPage.defaultProps = {
  events: [],
};

export default OutstandingEventsPage;
