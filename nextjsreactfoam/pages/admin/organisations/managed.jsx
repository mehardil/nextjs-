...
const ManagedOrganisations = ({ organisations, context, meta }) => {
...
ManagedOrganisations.authorized = true;
ManagedOrganisations.allowedRoles = [ADMIN];
ManagedOrganisations.Layout = DashboardLayout;
ManagedOrganisations.defaultProps = {
  organisations: [],
};

export default ManagedOrganisations;
