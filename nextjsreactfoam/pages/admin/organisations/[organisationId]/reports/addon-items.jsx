...
import OrganisationReportItemAddonTable from "@/components/common/OrganisationReportItemAddonTable";
...
const AddonItems = ({ organisation, ...props }) => {
            ...
            <>
              {
                ...
                >
                  ...
                  <OrganisationReportItemAddonTable />
                </Panel>
              }
            </>
          );
...
AddonItems.authorized = true;
AddonItems.allowedRoles = [ADMIN];
AddonItems.Layout = ViewOrganisationLayout;
AddonItems.defaultProps = {
  AddonItemss: [],
};
