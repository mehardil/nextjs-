...
import OrganisationReportDiscountTable from "@/components/common/OrganisationReportDiscountTable";
...
const Discount = ({ organisation, ...props }) => {
            ...
            <>
              {
                ...
                >
                  ...
                  <OrganisationReportDiscountTable />
                </Panel>
              }
            </>
          );
...
Discount.authorized = true;
Discount.allowedRoles = [ADMIN];
Discount.Layout = ViewOrganisationLayout;
