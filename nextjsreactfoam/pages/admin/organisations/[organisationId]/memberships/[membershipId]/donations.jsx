...
import MemberhsipDonationForm from "@/components/forms/MemberhsipDonationForm";
...
const addons = ({ membership, context }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader title="Donations" toolbar={pageHeaderToolbar} />

      <Panel title="Donations" color="inverse">
        <FormProvider {...methods}>
          <form autoComplete="off">
            <MemberhsipDonationForm />
          </form>
        </FormProvider>
      </Panel>
    </ContentErrorBoundary>
...
addons.Layout = ViewOrganisationMembershipLayout;
