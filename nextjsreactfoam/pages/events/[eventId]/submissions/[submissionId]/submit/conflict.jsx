  ...
  return (
    ...
    >
      <div className="form-group">
        <SanitizedHTML html={submission?.title_text} />

        {formState?.errors?.title?.message && (
          <Note color="danger">
            <span>{t("errors.forms.title")}</span>
          </Note>
        )}
        <Controller
          name="title"
          rules={{
            required: t("errors.forms.required", {
              field: t("common.forms.fields.title"),
            }),
          }}
          control={control}
...
SubmissionConflictPage.authorized = true;
SubmissionConflictPage.Layout = DashboardLayout;

export default SubmissionConflictPage;
