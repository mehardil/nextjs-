...
import DelegateConvenorTechnicalAbstractsHeader from "@/components/common/DelegateConvenorTechnicalAbstractsHeader";
...
const ConvenorTechnicalAbstracts = ({ event, session }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader
        title="Technical Abstracts"
        description={<DelegateConvenorTechnicalAbstractsHeader />}
      />
...
ConvenorTechnicalAbstracts.authorized = true;
ConvenorTechnicalAbstracts.Layout = DelegateDashboardLayout;

export default ConvenorTechnicalAbstracts;
