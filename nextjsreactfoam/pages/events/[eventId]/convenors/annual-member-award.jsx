...
import DelegateConvenorAnnualMemberAwardHeader from "@/components/common/DelegateConvenorAnnualMemberAwardHeader";
...
const ConvenorAnnualMemberAward = ({ event, session }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader
        title="Annual Member Award"
        description={<DelegateConvenorAnnualMemberAwardHeader />}
      />
...
ConvenorAnnualMemberAward.authorized = true;
ConvenorAnnualMemberAward.Layout = DelegateDashboardLayout;

export default ConvenorAnnualMemberAward;
