...
import DelegateConvenorEncouragementAwardHeader from "@/components/common/DelegateConvenorEncouragementAwardHeader";
...
const ConvenorEncouragementAward = ({ event, session }) => {
  ...
  return (
    <ContentErrorBoundary>
      <PageHeader
        ...
        description={<DelegateConvenorEncouragementAwardHeader />}
      />
...
ConvenorEncouragementAward.authorized = true;
ConvenorEncouragementAward.Layout = DelegateDashboardLayout;

export default ConvenorEncouragementAward;
