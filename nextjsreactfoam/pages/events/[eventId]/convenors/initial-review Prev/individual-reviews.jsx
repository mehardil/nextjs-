...
import ConvenorIndividualReviewsTable from "@/components/common/ConvenorIndividualReviewsTable";
import { useDelegateDashboardDispatch } from "@/contexts/DelegateDashboardContext";

const ConvenorIndividualReviews = ({
  event,
  reviews,
  meta,
  context,
            ...
            <>
              {isGrid && (
                ...
                >
                  ...
                  <ConvenorIndividualReviewsTable items={reviews} />
                </Panel>
              )}
            </>
          );
...
ConvenorIndividualReviews.authorized = true;
ConvenorIndividualReviews.Layout = DelegateDashboardLayout;

export default ConvenorIndividualReviews;
